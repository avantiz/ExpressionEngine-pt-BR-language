...
Se você não solicitou seu nome de usuário, por favor entre em contato com um Administrador imediatamente.
...
Notas complementares de {reporter_name}:
{notes}
        ...
        <section class="flex-wrap">
            <section class="wrap">
                <div class="panel redirect">
					...
					Este site encontra-se offline no momento
                    </div>
                </div>
            </section>
        </section>
...
<html>
	<head>
		<title>Seja bem-vindo(a) ao ExpressionEngine!</title>
  ...
  <div class="panel-heading" style="text-align: center;">
    <h3>O ExpressionEngine foi instalado!</h3>
  </div>
  <div class="panel-body">
    <div class="updater-msg">
  		<p style="margin-bottom: 20px;">Se você está vendo esta mensagem, então tudo correu bem.</p>
  		...
  		<div class="alert alert--attention">
            ...
            <div class="alert__content">
    			<p>Se você é o proprietário do site, por favor faça seu login no Painel de Controle  e crie seu primeiro template.</p>
    		</div>
  		</div>
  		<div class="alert alert--attention">
            <div class="alert__icon">
            ...
            <div class="alert__content">
    			<p>Se esta é a sua primeira vez usando o ExpressionEngine CMS, tenha certeza de <a href="https://docs.expressionengine.com/latest/getting-started/the-big-picture.html">dar uma olhada na documentação</a> para começar.</p>
    		</div>
  		</div>
  	</div>
  </div>
