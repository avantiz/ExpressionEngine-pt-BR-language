...
$lang = array(
    ...
    'choose_translation_file' => 'Selecione um arquivo para traduzir',

    'clear_caching' => 'Zerar Dados em Cache',
    ...
    'page_caching' => 'Arquivos de Cache de Página (template)',

    'php_info' => 'Info do PHP',

    'recount_stats' => 'Recontar Estatísticas',

    'replace_term' => 'E substituir por este texto',

    'replace_where' => 'Em qual campo do banco de dados você deseja que a substituição aconteça?',

    'sandr_instructions' => 'Estes formulários permitem que você busque por um texto específico e substitua-o por texto diferente',
    ...
    'translation_dir_unwritable' => 'Alerta: Sua pasta de tradução não possui permissões de gravação.',
